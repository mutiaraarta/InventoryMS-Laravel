 ...
 $product = Product::findOrFail($request->product_id);
    ...
    if ($product->qty < $request->qty) {
        return response()->json([
            'failed' => false,
            'message' => 'Stok tidak mencukupi! Stok tersedia hanya ' . $product->qty
        ]);
    }
    ...
    if ($product->qty < $request->qty) {
        ...
        return response()->json([
            'success'    => true,
            'message'    => 'Produk keluar berhasil ditambahkan'
        ]);
    }
   ...
   public function destroy($id)
{
    ...
    $product = Product::findOrFail($product_keluar->product_id);
    ...
    return response()->json([
        'success' => true,
        'message' => 'Produk keluar berhasil dihapus dan stok dikembalikan'
    ]);
}
