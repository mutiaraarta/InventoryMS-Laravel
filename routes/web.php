...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/apikategori', 'kategoriController@apikategori')->name('api.kategori');
	Route::get('/exportCategoriesAll', 'kategoriController@exportCategoriesAll')->name('exportPDF.categoriesAll');
	Route::get('/exportCategoriesAllExcel', 'kategoriController@exportExcel')->name('exportExcel.categoriesAll');
